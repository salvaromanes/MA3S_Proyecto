...
CREATE TABLE CLIENTE (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHAALTA DATE NOT NULL, FECHABAJA DATE, IDENTIFICACION VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, TIPOCLIENTE VARCHAR NOT NULL, USER_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE PAUTORIZADA (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR, FECHAFIN DATE, FECHAINICIO TIMESTAMP, FECHANACIMIENTO DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, NOMBRE VARCHAR NOT NULL, TIPO VARCHAR, USER_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE USUARIO (USUARIO VARCHAR NOT NULL, CONTRASENA VARCHAR NOT NULL, EMAIL VARCHAR NOT NULL, ESADMIN BOOLEAN NOT NULL, ESTADO VARCHAR, PRIMARY KEY (USUARIO))
