...
CREATE TABLE CLIENTE (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHABAJA DATE, FECHA_ALTA DATE NOT NULL, IDENTIFICACION VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, TIPO_CLIENTE VARCHAR NOT NULL, USER_USUARIO VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE PAUTORIZADA (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR, FECHANACIMIENTO DATE, FECHAFIN DATE, FECHAINICIO TIMESTAMP, IDENTIFICACION VARCHAR NOT NULL UNIQUE, NOMBRE VARCHAR NOT NULL, TIPO VARCHAR, USER_USUARIO VARCHAR, PRIMARY KEY (ID))
CREATE TABLE POOLED (IBAN VARCHAR NOT NULL, SALDO DOUBLE, PRIMARY KEY (IBAN))
...
CREATE TABLE TRANSACCION (IDUNICO VARCHAR NOT NULL, CANTIDAD DOUBLE NOT NULL, COMISION DOUBLE, FECHAEJECUCION DATE, FECHAINSTRUCCION DATE NOT NULL, INTERNACIONAL CHAR, TIPO VARCHAR NOT NULL, CUENTADESTINO_IBAN VARCHAR, CUENTAORIGEN_IBAN VARCHAR, DIVISAEMISOR_ABREVIATURA VARCHAR, DIVISARECEPTOR_ABREVIATURA VARCHAR, PRIMARY KEY (IDUNICO))
CREATE TABLE USUARIO (USUARIO VARCHAR NOT NULL, APELLIDOS VARCHAR NOT NULL, CONTRASENA VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, EMAIL VARCHAR NOT NULL, ESADMIN BOOLEAN NOT NULL, ESTADO VARCHAR, FECHA_NACIMIENTO DATE, NOMBRE VARCHAR NOT NULL, ROL VARCHAR NOT NULL, PRIMARY KEY (USUARIO))
...
ALTER TABLE CLIENTE ADD CONSTRAINT FK_CLIENTE_USER_USUARIO FOREIGN KEY (USER_USUARIO) REFERENCES USUARIO (USUARIO)
...
ALTER TABLE PAUTORIZADA ADD CONSTRAINT FK_PAUTORIZADA_USER_USUARIO FOREIGN KEY (USER_USUARIO) REFERENCES USUARIO (USUARIO)
