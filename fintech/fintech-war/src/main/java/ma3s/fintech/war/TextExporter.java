...
public class TextExporter extends DataTableExporter {
    ...
    @Override
    protected void preExport(FacesContext context, ExportConfiguration exportConfiguration) throws IOException, UnsupportedEncodingException {
    ...
    @Override
    protected void postExport(FacesContext context, ExportConfiguration exportConfiguration) throws IOException, IOException {
