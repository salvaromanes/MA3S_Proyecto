...
CREATE TABLE CLIENTE (ID BIGINT NOT NULL, DTYPE VARCHAR(31), CIUDAD VARCHAR NOT NULL, CODIGOPOSTAL VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR NOT NULL, FECHAALTA DATE NOT NULL, FECHABAJA DATE, IDENTIFICACION VARCHAR NOT NULL, PAIS VARCHAR NOT NULL, TIPOCLIENTE VARCHAR NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE PAUTORIZADA (ID BIGINT NOT NULL, APELLIDOS VARCHAR NOT NULL, DIRECCION VARCHAR NOT NULL, ESTADO VARCHAR, FECHAFIN DATE, FECHAINICIO TIMESTAMP, FECHANACIMIENTO DATE, IDENTIFICACION VARCHAR NOT NULL UNIQUE, NOMBRE VARCHAR NOT NULL, PRIMARY KEY (ID))
...
CREATE TABLE USUARIO (USER VARCHAR NOT NULL, CONTRASENA VARCHAR NOT NULL, ESADMIN BOOLEAN NOT NULL, ESTADO VARCHAR, CLIENTE_ID BIGINT, PAUTORIZADA_ID BIGINT, PRIMARY KEY (USER))
...
ALTER TABLE USUARIO ADD CONSTRAINT FK_USUARIO_PAUTORIZADA_ID FOREIGN KEY (PAUTORIZADA_ID) REFERENCES PAUTORIZADA (ID)
